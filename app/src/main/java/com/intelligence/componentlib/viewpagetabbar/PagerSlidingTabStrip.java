...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public interface IconTabProvider {
        ...
        int getPageSelectIconResId(int position);
    }
    ...
    private int mIndicatorColor = /*0xFF666666*/0xff111E36;
    private int mUnderlineColor = 0xff111E36;
    ...
    private int mDividerPadding = 8;//分割线的上下的padding
    ...
    private int mTabTextColor = /*0xFF666666*/0xFF828CA0;
    private int mSelectTabTextColor = /*0xFF666666*/0xff111E36;
    private Typeface mTabTypeface = null;
    private int mTabTypefaceStyle = Typeface.BOLD;

    private int mLastScrollX = 0;

    private int mTabBackgroundResId = R.drawable.browser_background_tab;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        mSelectTextSize = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, mSelectTextSize, dm);
        mSelectTabTextColor = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, mSelectTabTextColor, dm);
...
//
        ...
        mSelectTextSize = a.getDimensionPixelSize(0, mSelectTextSize);
        mSelectTabTextColor = a.getDimensionPixelSize(0, mSelectTabTextColor);
        ...
        mExpandedTabLayoutParams = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT, 1.0f);
    ...
    private void updateTabStyles() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            if (mPager.getAdapter() instanceof IconTabProvider) {
                ...
                if (i == mPager.getCurrentItem()) {
                    updateTextViewStyle(i, mSelectTabTextColor, mTabTextSize,true);//初始化
                } else {
                    updateTextViewStyle(i, mSelectTabTextColor, mSelectTextSize,false);
                }
            }
        }
    ...
    private void updateTextViewStyle(int i, int tabTc, int tabTs,boolean isSelect) {
        if (i < 0 || i > mTabCount) {
            return;
        }
...
//        }
    ...
    public void setTextSize(int selectTextSizePx,int unSelectTextSize) {
        this.mTabTextSize = (int) ScreenUtils.dpToPx(getContext(), selectTextSizePx);
        this.mSelectTextSize = (int) ScreenUtils.dpToPx(getContext(), unSelectTextSize);
        updateTabStyles();
    }
