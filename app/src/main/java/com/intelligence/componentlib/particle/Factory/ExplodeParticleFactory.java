...
import com.intelligence.componentlib.particle.Particle.ExplodeParticle;
...
public class ExplodeParticleFactory extends ParticleFactory{
    public static final int PART_WH = 5; //默认小球宽高
    public static final float X = Utils.dp2Px(3);
    public static final float Y = Utils.dp2Px(5);
    public static final float V = Utils.dp2Px(2);
    public static final float W = Utils.dp2Px(1);
    public static final float END_VALUE = 1.7f;
    private Rect mBound;
