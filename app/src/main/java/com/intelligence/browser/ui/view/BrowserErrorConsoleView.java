...
public class BrowserErrorConsoleView extends LinearLayout {
    ...
    private PreBrowserWebView mWebView;
    ...
    public BrowserErrorConsoleView(Context context, AttributeSet attributes) {
    ...
    private void commonSetupIfNeeded() {
        ...
        inflater.inflate(R.layout.browser_error_console, this);

        // Get references to each ui element.
        mConsoleHeader = findViewById(R.id.error_console_header_id);
        mErrorList = findViewById(R.id.error_console_list_id);
        mEvalJsViewGroup = findViewById(R.id.error_console_eval_view_group_id);
        mEvalEditText = findViewById(R.id.error_console_eval_text_id);
        mEvalButton = findViewById(R.id.error_console_eval_button_id);
     ...
     */
    public void setWebView(PreBrowserWebView webview) {
        mWebView = webview;
    }
    ...
    private static class ErrorConsoleListView extends ListView {
        ...
        private static class ErrorConsoleMessageList extends android.widget.BaseAdapter
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                TextView headline = view.findViewById(android.R.id.text1);
                TextView subText = view.findViewById(android.R.id.text2);
