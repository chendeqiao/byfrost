...
public class BrowserBreadCrumbView extends LinearLayout implements OnClickListener {
    private static final int DIVIDER_PADDING = 12; // dips
    private static final int CRUMB_PADDING = 8; // dips

    public interface Controller {
        void onTop(BrowserBreadCrumbView view, int level, Object data);
    }
     ...
     * @param defStyle
     */
    public BrowserBreadCrumbView(Context context, AttributeSet attrs, int defStyle) {
     ...
     * @param attrs
     */
    public BrowserBreadCrumbView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
...
/*        TypedArray a = mContext.obtainStyledAttributes(android.R.styleable.Theme);
        mSeparatorDrawable = a.getDrawable(android.R.styleable.Theme_dividerVertical);
        a.recycle();*/
    ...
    private void addBackButton() {
        ...
        mBackButton.setImageResource(R.drawable.browser_back_hierarchy_holo_dark);
