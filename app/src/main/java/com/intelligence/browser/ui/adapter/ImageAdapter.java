...
public class ImageAdapter {
    ...
    public void addView(final ImageItem imageItem, ViewGroup parent, int position) {
        ...
        convertView = mInflater.inflate(R.layout.browser_imagechoose, parent, false);
        holder.mRoot = convertView;
        holder.mChoose = convertView.findViewById(R.id.choose);
        holder.mClose = convertView.findViewById(R.id.close);
        holder.mAddIcon = convertView.findViewById(R.id.icon_add);
        ...
        switch (type) {
            ...
            case IMAGE_ADD:
                if (position != 3) {
                    ...
                    holder.mChoose.setImageResource(R.drawable.browser_shape_bg_add_image);
