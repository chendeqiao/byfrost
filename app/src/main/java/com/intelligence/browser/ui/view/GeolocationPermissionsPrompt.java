...
public class GeolocationPermissionsPrompt extends RelativeLayout {
    ...
    private void init() {
        ...
        mDontShareButton = findViewById(R.id.dont_share_button);
    ...
    private void handleButtonClick(boolean allow) {
        ...
        if (remember) {
            //TODO:No site settings in Settings,Temporarily turn off
...
//            toast.show();
    ...
    private void setMessage(CharSequence origin) {
        mMessage.setText(getResources().getString(R.string.geolocation_permissions_prompt_message, origin));
    }
}
