...
import com.intelligence.browser.reflections.SearchManagerExtension;
...
public class DefaultSearchEngine implements SearchEngine {
    ...
    public static DefaultSearchEngine create(Context context) {
        ...
        ComponentName name = SearchManagerExtension.getWebSearchActivity(searchManager);
    ...
    public Intent startSearch(Context context, String query, Bundle appData, String extraData) {
        try {
            ...
            intent.putExtra(BrowserHelper.EXTRA_APPLICATION_ID, context.getPackageName());
...
//            context.startActivity(intent);
    ...
    public Cursor getSuggestions(Context context, String query) {
        ...
        return SearchManagerExtension.getSuggestions(searchManager, mSearchable, query);
    }
