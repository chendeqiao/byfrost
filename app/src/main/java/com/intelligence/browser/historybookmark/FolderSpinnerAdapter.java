    ...
    private void bindView(int position, View view, boolean isDropDown) {
        ...
        switch (position) {
            case HOME_SCREEN:
                ...
                drawableResource = R.drawable.browser_home_holo_dark;
                break;
            case ROOT_FOLDER:
                labelResource = R.string.bookmarks;
                drawableResource = R.drawable.browser_bookmarks_holo_dark;
                break;
            case RECENT_FOLDER:
                // Fall through and use the same icon resource
            case OTHER_FOLDER:
                labelResource = R.string.add_to_other_folder_menu_option;
                drawableResource = R.drawable.browser_folder_holo_dark;
                break;
            default:
                labelResource = 0;
                drawableResource = 0;
