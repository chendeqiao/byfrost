...
public class BookmarksLoader extends CursorLoader {
    ...
    public static final int COLUMN_INDEX_CREATE_TIME = 10;
    ...
    public static final String[] PROJECTION = new String[]{
            ...
            Bookmarks.PARENT, // 8
            Bookmarks.TYPE, // 9
            Bookmarks.DATE_CREATED, //10
    };

    String mAccountType;
    String mAccountName;

    public BookmarksLoader(Context context, String accountType, String accountName, @Nullable String selection, @Nullable String[] selectionArgs) {
        super(context, addAccount(Bookmarks.CONTENT_URI_DEFAULT_FOLDER, accountType, accountName),
                PROJECTION, selection, selectionArgs, Bookmarks.DATE_CREATED + " DESC");
