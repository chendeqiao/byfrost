...
public class BookmarkUtils {
    ...
    static Intent createShortcutIntent(String url) {
        ...
        shortcutIntent.setClassName(BrowserApplication.getInstance().getPackageName(), MainActivity.class.getName());
        shortcutIntent.putExtra(BrowserHelper.EXTRA_APPLICATION_ID, Long.toString(uniqueId));
    ...
    private static Bitmap getIconBackground(Context context, BookmarkIconType type, int density) {
        if (type == BookmarkIconType.ICON_HOME_SHORTCUT) {
            ...
            Drawable drawable = context.getResources().getDrawableForDensity(
                    R.drawable.browser_app_icon, density);
    ...
    static void displayRemoveBookmarkDialog(final long id, final String title,
        ...
        new BrowserDialog(context, context.getString(R.string.delete_bookmark_warning,title)) {
    ...
    public static void removeBookmark(final long id, final Context context) {
