...
import com.intelligence.browser.reflections.InputMethodManagerExtension;
...
public class BrowserAddBookmarkPage extends ActionBarActivity
        implements View.OnClickListener, TextView.OnEditorActionListener,
        AdapterView.OnItemClickListener, LoaderManager.LoaderCallbacks<Cursor>,
        BrowserBreadCrumbView.Controller, FolderSpinner.OnSetSelectionListener,
    ...
    private BrowserBreadCrumbView mCrumbs;
    ...
    private TextView mCancelAddBookmark;
    private TextView mSavedBookmark;
    ...
    public void onClick(View v) {
        if (R.id.actionbar_right_icon == v.getId()) {
            ...
            mFolderNamer.setSelection(mFolderNamer.getText().toString().length());
            ...
            InputMethodManagerExtension.focusIn(imm, mListView);
        ...
        } else if (R.id.saved_add_bookmark == v.getId()) {
            if (mFolderSelector.getVisibility() == View.VISIBLE) {
                // We are showing the folder selector.
                if (mIsFolderNamerShowing) {
                    completeOrCancelFolderNaming(false);
        ...
        } else if (R.id.cancel_add_bookmark == v.getId()) {
            this.finish();
        }
    }
    ...
    private LoaderCallbacks<EditBookmarkInfo> mEditInfoLoaderCallbacks =
            new LoaderCallbacks<EditBookmarkInfo>() {
                ...
                public Loader<EditBookmarkInfo> onCreateLoader(int id, Bundle args) {
                    return new EditBookmarkInfoLoader(BrowserAddBookmarkPage.this, mMap);
                }
            };
    ...
    private class FolderAdapter extends CursorAdapter {
        ...
        public View newView(Context context, Cursor cursor, ViewGroup parent) {
            View view = LayoutInflater.from(context).inflate(
                    R.layout.browser_folder_list_item, null);
    ...
    protected void onCreate(Bundle icicle) {
        ...
        setPageTitle(getResources().getString(R.string.edit_bookmark));
        ...
        mFakeTitle = findViewById(R.id.fake_title);
        ...
        mTitle.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus) {
                    mTitleLine.setBackgroundResource(R.color.mb_blue);
                } else {
                    mTitleLine.setBackgroundResource(R.color.add_book_mark_line);
                }
            }
        });
        ...
        mAddress.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus) {
                    mAddressLine.setBackgroundResource(R.color.mb_blue);
                } else {
                    mAddressLine.setBackgroundResource(R.color.add_book_mark_line);
                }
            }
        });
        ...
        mCancelAddBookmark = findViewById(R.id.cancel_add_bookmark);
        mSavedBookmark = findViewById(R.id.saved_add_bookmark);

        mCancelAddBookmark.setOnClickListener(this);
        mSavedBookmark.setOnClickListener(this);
        ...
        mFolderNamerHolder = getLayoutInflater().inflate(R.layout.browser_new_folder_layout, null);
        mFolderNamer = mFolderNamerHolder.findViewById(R.id.folder_namer);
        ...
        mCrumbs = findViewById(R.id.crumbs);
        mCrumbs.setUseBackButton(true);
        mCrumbs.setController(this);
        mHeaderIcon = getResources().getDrawable(R.drawable.browser_folder_holo_dark);
        ...
        mAccountSpinner = findViewById(R.id.accounts);
    ...
    private class SaveBookmarkRunnable implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                Bookmarks.addBookmark(BrowserAddBookmarkPage.this, false, url,
    ...
    private static class InnerHandler extends Handler {
        ...
        private WeakReference<BrowserAddBookmarkPage> mAddBookmarkPageHolder;

        public InnerHandler(BrowserAddBookmarkPage addBookmarkPage) {
            this.mAddBookmarkPageHolder = new WeakReference<>(addBookmarkPage);
        }

        @Override
        public void handleMessage(Message msg) {
            BrowserAddBookmarkPage addBookmarkPage = mAddBookmarkPageHolder.get();
            ...
            switch (msg.what) {
                case SAVE_BOOKMARK:
                    if (1 == msg.arg1) {
                        ToastUtil.showLongToast(addBookmarkPage, R.string.bookmark_saved);
                    } else {
                        ToastUtil.showLongToast(addBookmarkPage, R.string.bookmark_not_saved);
                    }
                    break;
                case TOUCH_ICON_DOWNLOADED:
                    Bundle b = msg.getData();
                    addBookmarkPage.sendBroadcast(BookmarkUtils.createAddToHomeIntent(
                            addBookmarkPage,
                            b.getString(BrowserContract.Bookmarks.URL),
                            b.getString(BrowserContract.Bookmarks.TITLE),
                            b.getParcelable(BrowserContract.Bookmarks.TOUCH_ICON),
                            b.getParcelable(BrowserContract.Bookmarks.FAVICON)));
                    break;
    ...
    boolean save() {
        ...
        if (mEditingExisting) {
            ...
            if (values.size() > 0) {
                new UpdateBookmarkTask(getApplicationContext(), id).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR,
                        values);
            }
            setResult(RESULT_OK);
        } else {
            ...
            Bitmap favicon;
            if (urlUnmodified) {
                thumbnail = mMap.getParcelable(
                        BrowserContract.Bookmarks.THUMBNAIL);
                favicon = mMap.getParcelable(
