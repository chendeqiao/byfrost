...
//        mUrlText = (TextView) findViewById(R.id.url);
        mImageView = findViewById(R.id.favicon);
...
//        star.setVisibility(View.GONE);
     ...
     */
    /* package */public void setFavicon(Bitmap b) {
        if (b != null) {
            mImageView.setImageBitmap(b);
        } else {
            mImageView.setImageResource(R.drawable.browser_toolbar_webview_home);
        }
    }
     ...
     */
    /* package */public void setName(String name) {
        if (name == null) {
            return;
        }
     ...
     */
    /* package */public void setUrl(String url) {
        if (url == null) {
            return;
        }
        ...
        // This change is cherry-picked from SWE.
