...
public class HttpAuthenticationDialog {
    ...
    private void createDialog() {
        ...
        View v = factory.inflate(R.layout.browser_http_authentication, null);
        mUsernameView = v.findViewById(R.id.username_edit);
        mPasswordView = v.findViewById(R.id.password_edit);
