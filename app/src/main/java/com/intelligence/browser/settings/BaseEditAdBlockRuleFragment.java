...
public abstract class BaseEditAdBlockRuleFragment extends BasePreferenceFragment implements BrowserSettingActivity.OnRightIconClickListener {
...
//        }
    ...
    protected BrowserDialog createInputDialog(@StringRes int title, String hint, String defaultText, final OnClickInputDialogOk onClickInputDialogOk) {
        ...
        View dialogContent = View.inflate(mPreferencesPage, R.layout.browser_dialog_input_rule, null);
        final EditText editText = dialogContent.findViewById(R.id.input);
    ...
    private void initTitle() {
        ...
        mPreferencesPage.setRightIcon(R.drawable.browser_input_search_delete);
        mPreferencesPage.setSecondRightIcon(R.drawable.browser_toolbar_close02);
    }
    ...
    private class AdBlockRuleAdapter extends BaseAdapter {
        ...
        private ViewHolder createAdBlockRuleItemView(ViewGroup parent) {
            View itemView = mInflater.inflate(R.layout.browser_item_rule, parent, false);
    ...
    private class ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        public ViewHolder(View itemView) {
            mItemView = itemView;
            mRuleTextView = itemView.findViewById(R.id.rule_text);
