...
public class BrowserFontSizeFragment extends BasePreferenceFragment
    ...
    private void initData() {
        ...
        BrowserSeekBarSummarySetting mPreference = (BrowserSeekBarSummarySetting) findPreference(PreferenceKeys.PREF_TEXT_ZOOM);
        mPreference.setMax(PREF_TEXT_ZOOM_MAX);
        mPreference.setOnPreferenceChangeListener(this);
        updateTextZoomSummary(mPreference, settings.getTextZoom());

        mPreference = (BrowserSeekBarSummarySetting) findPreference(PreferenceKeys.PREF_MIN_FONT_SIZE);
