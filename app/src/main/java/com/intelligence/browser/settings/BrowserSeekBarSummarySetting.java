...
public class BrowserSeekBarSummarySetting extends Preference
    ...
    public BrowserSeekBarSummarySetting(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public BrowserSeekBarSummarySetting(Context context, AttributeSet attrs) {
    ...
    protected void onBindView(View view) {
        ...
        mTextViewProgress = view.findViewById(
                R.id.progress);

        mSeekBar = view.findViewById(
                R.id.seekbar);
