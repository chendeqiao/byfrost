...
public class LanguageCountry {
    ...
    static public String COUNTRY_OPTION_MX = "MX";
    static public String COUNTRY_OPTION_ES = "ES";
    static public String COUNTRY_OPTION_PT = "PT";
    ...
    public void matchLanguageName(){
        mLanguageNameResId = R.string.base_settings_language_en;
        if(mLanguage.equalsIgnoreCase(LANGUAGE_OPTION_DE)){
            mLanguageNameResId = R.string.base_settings_language_de;
        }else if(mLanguage.equalsIgnoreCase(LANGUAGE_OPTION_EL)){
            mLanguageNameResId = R.string.base_settings_language_el;
        }else if(mLanguage.equalsIgnoreCase(LANGUAGE_OPTION_ES)){
            if(mCountry.equalsIgnoreCase(COUNTRY_OPTION_US)){
                mLanguageNameResId = R.string.base_settings_language_es_us;
            }else if(mCountry.equalsIgnoreCase(COUNTRY_OPTION_MX)){
                mLanguageNameResId = R.string.base_settings_language_es_la;
            }else if(mCountry.equalsIgnoreCase(COUNTRY_OPTION_ES)){
                mLanguageNameResId = R.string.base_settings_language_es_es;
            }else {
                mLanguageNameResId = R.string.base_settings_language_es;
            }
        }else if(mLanguage.equalsIgnoreCase(LANGUAGE_OPTION_FR)){
            mLanguageNameResId = R.string.base_settings_language_fr;
        }else if(mLanguage.equalsIgnoreCase(LANGUAGE_OPTION_HE)){
            mLanguageNameResId = R.string.base_settings_language_he;
            ...
            mLanguageNameResId = R.string.base_settings_language_hu;
        }else if(mLanguage.equalsIgnoreCase(LANGUAGE_OPTION_ID)){
            mLanguageNameResId = R.string.base_settings_language_id;
            ...
            mLanguageNameResId = R.string.base_settings_language_it;
        }else if(mLanguage.equalsIgnoreCase(LANGUAGE_OPTION_JA)){
            mLanguageNameResId = R.string.base_settings_language_ja;
        }else if(mLanguage.equalsIgnoreCase(LANGUAGE_OPTION_KO)){
            mLanguageNameResId = R.string.base_settings_language_ko;
        }else if(mLanguage.equalsIgnoreCase(LANGUAGE_OPTION_PT)){
            if(mCountry.equalsIgnoreCase(COUNTRY_OPTION_BR)){
                mLanguageNameResId = R.string.base_settings_language_pt_br;
            }else if(mCountry.equalsIgnoreCase(COUNTRY_OPTION_PT)){
                mLanguageNameResId = R.string.base_settings_language_pt_pt;
            }else{
                mLanguageNameResId = R.string.base_settings_language_pt;
            }
        }else if(mLanguage.equalsIgnoreCase(LANGUAGE_OPTION_RO)){
            mLanguageNameResId = R.string.base_settings_language_ro;
        }else if(mLanguage.equalsIgnoreCase(LANGUAGE_OPTION_RU)){
            mLanguageNameResId = R.string.base_settings_language_ru;
        }else if(mLanguage.equalsIgnoreCase(LANGUAGE_OPTION_SK)){
            mLanguageNameResId = R.string.base_settings_language_sk;
        }else if(mLanguage.equalsIgnoreCase(LANGUAGE_OPTION_TH)){
            mLanguageNameResId = R.string.base_settings_language_th;
        }else if(mLanguage.equalsIgnoreCase(LANGUAGE_OPTION_TR)){
            mLanguageNameResId = R.string.base_settings_language_tr;
        }else if(mLanguage.equalsIgnoreCase(LANGUAGE_OPTION_UK)){
            mLanguageNameResId = R.string.base_settings_language_uk;
        }else if(mLanguage.equalsIgnoreCase(LANGUAGE_OPTION_VI)){
            mLanguageNameResId = R.string.base_settings_language_vi;
        }else if(mLanguage.equalsIgnoreCase(LANGUAGE_OPTION_ZH)){
            if(mCountry.equalsIgnoreCase(COUNTRY_OPTION_CN)){
                mLanguageNameResId = R.string.base_settings_language_zh_cn;
            }else if(mCountry.equalsIgnoreCase(COUNTRY_OPTION_TW)){
                mLanguageNameResId = R.string.base_settings_language_zh_tw;
            }
        }else if(mLanguage.equalsIgnoreCase(LANGUAGE_OPTION_AR)){
            mLanguageNameResId = R.string.base_settings_language_ar;
        }else if(mLanguage.equalsIgnoreCase(LANGUAGE_OPTION_NL)){
            mLanguageNameResId = R.string.base_settings_language_nl;
        }else if(mLanguage.equalsIgnoreCase(LANGUAGE_OPTION_NB)){
            mLanguageNameResId = R.string.base_settings_language_nb;
        }else if(mLanguage.equalsIgnoreCase(LANGUAGE_OPTION_PL)){
            mLanguageNameResId = R.string.base_settings_language_pl;
        }else if(mLanguage.equalsIgnoreCase(LANGUAGE_OPTION_HR)){
            mLanguageNameResId = R.string.base_settings_language_hr;
        }else if(mLanguage.equalsIgnoreCase(LANGUAGE_OPTION_CS)){
            mLanguageNameResId = R.string.base_settings_language_cs;
        }else if(mLanguage.equalsIgnoreCase(LANGUAGE_OPTION_MS)){
            mLanguageNameResId = R.string.base_settings_language_ms;
        }else if(mLanguage.equalsIgnoreCase(LANGUAGE_OPTION_SR)){
            mLanguageNameResId = R.string.base_settings_language_sr;
        }else if(mLanguage.equalsIgnoreCase(LANGUAGE_OPTION_BG)){
            mLanguageNameResId = R.string.base_settings_language_bg;
        }else if(mLanguage.equalsIgnoreCase(LANGUAGE_OPTION_DA)){
            mLanguageNameResId = R.string.base_settings_language_da;
        }else if(mLanguage.equalsIgnoreCase(LANGUAGE_OPTION_HI)){
            mLanguageNameResId = R.string.base_settings_language_hi;
        }
        //如果上面匹配不到，则是默认的英语（包括英语国家和不支持的语种），所以将mLanguage和mCountry置为英语
        if(mLanguageNameResId == R.string.base_settings_language_en){
