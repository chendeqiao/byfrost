...
public class BrowserClearDataPreferencesFragment extends BasePreferenceFragment {
    ...
    private class ClearDataAdapter extends BaseAdapter {
        ...
        private View createClearDataItemView(int position, ViewGroup parent) {
            View itemView = mInflater.inflate(R.layout.browser_item_clear_data, parent, false);
        ...
        private View createListViewFoot(ViewGroup parent) {
            View foot = LayoutInflater.from(getActivity()).inflate(R.layout.browser_clear_button, parent, false);
            mClearAllButton = foot.findViewById(R.id.clear_all_button);
    ...
    private class ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View itemView) {
            mItemView = itemView;
            mNameTextView = itemView.findViewById(R.id.data_name);
            mDescriptionTextView = itemView.findViewById(R.id.data_description);
            mClearTextView = itemView.findViewById(R.id.clear_text);
