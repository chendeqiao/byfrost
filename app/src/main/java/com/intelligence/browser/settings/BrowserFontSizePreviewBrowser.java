...
public class BrowserFontSizePreviewBrowser extends BrowserWebViewPreview {
    ...
    public BrowserFontSizePreviewBrowser(
            Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public BrowserFontSizePreviewBrowser(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public BrowserFontSizePreviewBrowser(Context context) {
        super(context);
    }
