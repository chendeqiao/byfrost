...
public class SearchInputHintView extends LinearLayout implements View.OnClickListener {
    ...
    protected void onFinishInflate() {
        ...
        mHintTextView1 = findViewById(R.id.hint1);
        mHintTextView2 = findViewById(R.id.hint2);
        mHintTextView3 = findViewById(R.id.hint3);
        mHintTextView4 = findViewById(R.id.hint4);
        mHintTextView5 = findViewById(R.id.hint5);
