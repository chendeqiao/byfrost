...
public class MorphingButton extends Button {
    ...
    private StrokeGradientDrawable mDrawableShadow;
    ...
    private void morphWithoutAnimation(@NonNull Params params) {
        ...
        mDrawableShadow.setCornerRadius(params.cornerRadius);
        mDrawableShadow.setStrokeWidth(params.strokeWidth);
    ...
    private void initView() {
        ...
        StateListDrawable shadow = new StateListDrawable();
        shadow.addState(StateSet.WILD_CARD, mDrawableShadow.getGradientDrawable());
