...
import com.intelligence.browser.ui.ContextMenuClickListener;
import com.intelligence.browser.webview.Controller;
import com.intelligence.browser.R;
import com.intelligence.browser.utils.ViewUtils;
...
public class ContextMenuDialog {
    ...
    public void show(int type, float touchX, float touchY) {
        ...
        lp.width = (int)mContext.getResources().getDimension(R.dimen.context_menu_dialog_maxwidth);
    ...
    private void initContentView() {
        mContentView = null;
        mContentView = ((Activity)mContext).getLayoutInflater().inflate(R.layout.browser_contextmenu_dialog_layout, null);
        mContentParent = mContentView.findViewById(R.id.menu_item_parent);
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(ScreenUtils.dpToPxInt(mContext,200), ViewGroup.LayoutParams.WRAP_CONTENT);
        ...
        for (int i = 0; i < mMenuData[0].length; i++) {
            ...
            textView.setTextColor(mContext.getResources().getColor(R.color.browser_title_color));
            ...
            if (i != mMenuData[0].length - 1) {
                ...
                divider.setBackgroundColor(mResource.getColor(R.color.settings_list_divider));
