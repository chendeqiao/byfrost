...
public class SelectWebSiteView extends RelativeLayout implements WebSiteItemAnimator.OnAnimationEnd, View
        .OnClickListener {
    ...
    private WebSiteSuspanededView mSuspendedImageView;
    ...
    public SelectWebSiteView(Context context, BaseUi ui, View view) {
        super(context);
        mClickView = view;
        mUi = ui;
        initView();
...
//        WebSiteItemAnimator animator = new WebSiteItemAnimator();
...
//
//        mSuspendedImageView = new WebSiteSuspanededView(getContext(), mClickView, false);
...
//        LayoutParams layoutParams = new LayoutParams(mClickWidth, mClickHeight);
...
//    }
    ...
    public void onItemClick(View item) {
        ...
        mSuspendedImageView = new WebSiteSuspanededView(getContext(), item, true);
        mSuspendedImageView.setImage(info.getName());
        mSuspendedImageView.setBackgroundResource(R.drawable.browser_searchengine_item_bg);
    ...
    public class SearchEngineAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
            ...
            return new ViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout
                    .browser_select_search_engine_item, null));
