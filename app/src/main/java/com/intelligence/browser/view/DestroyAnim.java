...
public class DestroyAnim {
    ...
    public void start(final Runnable onComplete){
        ...
        getDecorView().post(new Runnable() {
            ...
            public void run() {
                ...
                destroyView.setLayoutParams(new FrameLayout.LayoutParams(getDecorView().getWidth(), getDecorView().getHeight()));
                destroyView.setDelegateView(getDecorView(), bgColor);
    ...
    private static class DestroyView extends View {
        ...
        public void setDelegateView(View view, int bgColor){
            delegateView = view;
            this.bgColor = bgColor;
            ...
            delegateView.post(new Runnable() {
                public void run() {
                    bitmap = Bitmap.createBitmap(delegateView.getWidth(), delegateView.getHeight(), Bitmap.Config.RGB_565);
        ...
        private int getHorizontalCount(){
            ...
            return horizontal_count = (w > h ? 7 : 6);
        }
