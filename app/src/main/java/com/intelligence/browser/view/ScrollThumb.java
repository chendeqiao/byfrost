...
public class ScrollThumb {
    ...
    private final BaseWebView mAwContents;
    ...
    public ScrollThumb(BaseWebView awContents, Context context, boolean isNightMode) { //ViewGroup view,
        ...
        mThumbDrawable = context.getResources().getDrawable(R.drawable.browser_scroll_thumb);
        mThumbDrawableNight = context.getResources().getDrawable(R.drawable.browser_scroll_thumb);
     ...
     */
    public static boolean checkVelocityThreshold(BaseWebView awContents, ViewGroup view, float threshold) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (mDragging
                    ...
                    if (!mLongPressed) {
                        ...
                        mLongPressed = mThisEventTime - mLastDownTime > 100;
                    }
                }
...
//            bottom = scrollY + (int)(position) - mView.getPaddingBottom();
    ...
    private static class ScrollabilityCache implements Runnable {
        ...
        private BaseWebView mHostContents;
        ...
        public ScrollabilityCache(ViewConfiguration configuration, ViewGroup hostView, BaseWebView awContents) {
