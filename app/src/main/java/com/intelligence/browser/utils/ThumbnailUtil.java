...
public class ThumbnailUtil implements Closeable {
    ...
    private void init() {
        ...
        mThumbnailW = com.intelligence.commonlib.tools.DisplayUtil.getScreenWidth(mContext) / mMultiple;
        mThumbnailH = com.intelligence.commonlib.tools.DisplayUtil.getScreenHeight(mContext) / mMultiple;
