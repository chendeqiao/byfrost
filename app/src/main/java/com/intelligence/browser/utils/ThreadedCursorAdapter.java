...
public abstract class ThreadedCursorAdapter<T> extends BaseAdapter {
    ...
    public ThreadedCursorAdapter(Context context, Cursor c) {
        ...
        mHandler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                bindView(view, container.position, container.bind_object);
            }
        };
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (container.position == position
                ...
                && container.loaded
                && container.generation == mGeneration) {
            bindView(convertView, container.position, container.bind_object);
        } else {
            bindView(convertView, container.position, cachedLoadObject());
            if (mHasCursor) {
                container.position = position;
    ...
    public abstract void bindView(View view, int position, T object);
