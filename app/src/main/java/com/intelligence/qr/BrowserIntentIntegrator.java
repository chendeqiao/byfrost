...
import com.intelligence.qr.zxing.IntentResult;
import com.intelligence.qr.zxing.client.android.Intents;
...
@Deprecated
public class BrowserIntentIntegrator {

    public static final int REQUEST_CODE = 0x0000c0de; // Only use bottom 16 bits

    private static final String TAG = BrowserIntentIntegrator.class.getSimpleName();
    ...
    private int requestCode = ActivityUtils.QRCODE_RESULT;

    protected Class<?> getDefaultCaptureActivity() {
        return BrowserCaptureActivity.class;
    }

    public BrowserIntentIntegrator(Activity activity) {
     ...
     */
    public BrowserIntentIntegrator setCaptureActivity(Class<?> captureActivity) {
     ...
     * @return this
     */
    public BrowserIntentIntegrator setRequestCode(int requestCode) {
     ...
     *                 of an {@link Activity}
     */
    public static BrowserIntentIntegrator forSupportFragment(androidx.fragment.app.Fragment fragment) {
        BrowserIntentIntegrator integrator = new BrowserIntentIntegrator(fragment.getActivity());
    ...
    public static BrowserIntentIntegrator forFragment(Fragment fragment) {
        BrowserIntentIntegrator integrator = new BrowserIntentIntegrator(fragment.getActivity());
    ...
    public final BrowserIntentIntegrator addExtra(String key, Object value) {
     ...
     */
    public final BrowserIntentIntegrator setPrompt(String prompt) {
        if (prompt != null) {
     ...
     */
    public BrowserIntentIntegrator setOrientationLocked(boolean locked) {
     ...
     * @return this
     */
    public BrowserIntentIntegrator setCameraId(int cameraId) {
        if (cameraId >= 0) {
     ...
     * @return this
     */
    public BrowserIntentIntegrator setTorchEnabled(boolean enabled) {
     ...
     * @return this
     */
    public BrowserIntentIntegrator setBeepEnabled(boolean enabled) {
     ...
     * @return this
     */
    public BrowserIntentIntegrator setBarcodeImageEnabled(boolean enabled) {
     ...
     * @return this
     */
    public BrowserIntentIntegrator setDesiredBarcodeFormats(Collection<String> desiredBarcodeFormats) {
     ...
     * @return this
     */
    public BrowserIntentIntegrator setDesiredBarcodeFormats(String... desiredBarcodeFormats) {
     ...
     */
    public BrowserIntentIntegrator setTimeout(long timeout) {
