...
import com.intelligence.qr.zxing.client.android.DecodeFormatManager;
import com.intelligence.qr.zxing.client.android.DecodeHintManager;
...
public class DecoratedBarcodeView extends FrameLayout {
    ...
    private void initialize(AttributeSet attrs) {
        ...
        int scannerLayout = attributes.getResourceId(
                R.styleable.zxing_view_zxing_scanner_layout, R.layout.browser_zxing_barcode_scanner);

        attributes.recycle();

        inflate(getContext(), scannerLayout, this);

        barcodeView = findViewById(com.intelligence.browser.R.id.zxing_barcode_surface);
    ...
    public boolean isOpenLight() {
        if(barcodeView != null) {
          return barcodeView.isOpenLight();
        }
        return false;
    }
