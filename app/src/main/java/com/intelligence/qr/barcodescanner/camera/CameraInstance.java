...
import com.intelligence.qr.barcodescanner.Size;
import com.intelligence.qr.barcodescanner.Util;
...
public class CameraInstance {
    ...
    public boolean isOpenLight(){
        if(cameraManager != null){
            return cameraManager.isOpenLight();
        }
        return false;
    }
    /**
        ...
        public void run() {
            try {
                ...
                if (readyHandler != null) {
                    readyHandler.obtainMessage(com.intelligence.browser.R.id.zxing_prewiew_size_ready, getPreviewSize()).sendToTarget();
                }
            } catch (Exception e) {
                notifyError(e);
