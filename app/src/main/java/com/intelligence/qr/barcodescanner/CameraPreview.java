...
import com.intelligence.qr.barcodescanner.camera.CameraParametersCallback;
import com.intelligence.qr.barcodescanner.camera.CameraSettings;
import com.intelligence.qr.barcodescanner.camera.CameraSurface;
import com.intelligence.qr.barcodescanner.camera.CenterCropStrategy;
import com.intelligence.qr.barcodescanner.camera.DisplayConfiguration;
import com.intelligence.qr.barcodescanner.camera.FitCenterStrategy;
import com.intelligence.qr.barcodescanner.camera.FitXYStrategy;
import com.intelligence.qr.barcodescanner.camera.PreviewScalingStrategy;
...
public class CameraPreview extends ViewGroup {
    ...
    private final Handler.Callback stateCallback = new Handler.Callback() {
        ...
        public boolean handleMessage(Message message) {
            if (message.what == R.id.zxing_prewiew_size_ready) {
                ...
                return true;
            } else if (message.what == com.intelligence.browser.R.id.zxing_camera_error) {
    ...
    public boolean isOpenLight(){
        if(cameraInstance != null){
            return cameraInstance.isOpenLight();
        }
        return false;
    }
