...
import com.intelligence.qr.zxing.client.android.BeepManager;
import com.intelligence.qr.zxing.client.android.InactivityTimer;
...
public class CaptureManager {
    ...
    protected void returnResult(BarcodeResult rawResult) {
        ...
        intent.putExtra(Controller.QR_CODE, rawResult.mResult.getText());
    ...
    protected void displayFrameworkBugMessageAndExit(String message) {
        ...
        if (message.isEmpty()) {
            message = activity.getString(com.intelligence.browser.R.string.zxing_msg_camera_framework_bug);
        }
