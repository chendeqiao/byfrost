...
public class ViewfinderView extends View {
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        TypedArray attributes = getContext().obtainStyledAttributes(attrs, com.intelligence.browser.R.styleable.zxing_finder);
