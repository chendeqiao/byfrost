...
package com.intelligence.qr.zxing.client.android;
...
public final class BeepManager {
    ...
    public MediaPlayer playBeepSound() {
        ...
        try {
            AssetFileDescriptor file = context.getResources().openRawResourceFd(com.intelligence.browser.R.raw.zxing_beep);
            try {
